...
int32_t confparser_serialize_tnt_config(uint8_t *buffer, const tnt_config *conf) {
	...
	buffer_append_float16(buffer, conf->kp1, 10, &ind);
	buffer_append_float16(buffer, conf->kp2, 10, &ind);
	buffer_append_float16(buffer, conf->kp3, 10, &ind);
	buffer_append_float16(buffer, conf->kp4, 10, &ind);
	...
	buffer_append_float16(buffer, conf->Q1, 10000, &ind);
	buffer_append_float16(buffer, conf->Q2, 10000, &ind);
	...
	buffer_append_float16(buffer, conf->roll1, 100, &ind);
	buffer_append_float16(buffer, conf->roll2, 100, &ind);
	buffer_append_float16(buffer, conf->roll3, 100, &ind);
	...
	buffer_append_float16(buffer, conf->brkroll1, 100, &ind);
	buffer_append_float16(buffer, conf->brkroll2, 100, &ind);
	buffer_append_float16(buffer, conf->brkroll3, 100, &ind);
...
bool confparser_deserialize_tnt_config(const uint8_t *buffer, tnt_config *conf) {
	...
	conf->kp1 = buffer_get_float16(buffer, 10, &ind);
	conf->kp2 = buffer_get_float16(buffer, 10, &ind);
	conf->kp3 = buffer_get_float16(buffer, 10, &ind);
	conf->kp4 = buffer_get_float16(buffer, 10, &ind);
	...
	conf->Q1 = buffer_get_float16(buffer, 10000, &ind);
	conf->Q2 = buffer_get_float16(buffer, 10000, &ind);
	...
	conf->roll1 = buffer_get_float16(buffer, 100, &ind);
	conf->roll2 = buffer_get_float16(buffer, 100, &ind);
	conf->roll3 = buffer_get_float16(buffer, 100, &ind);
	...
	conf->brkroll1 = buffer_get_float16(buffer, 100, &ind);
	conf->brkroll2 = buffer_get_float16(buffer, 100, &ind);
	conf->brkroll3 = buffer_get_float16(buffer, 100, &ind);
...
void confparser_set_defaults_tnt_config(tnt_config *conf) {
	...
	conf->kp1 = APPCONF_TNT_KP1;
	conf->kp2 = APPCONF_TNT_KP2;
	conf->kp3 = APPCONF_TNT_KP3;
	conf->kp4 = APPCONF_TNT_KP4;
